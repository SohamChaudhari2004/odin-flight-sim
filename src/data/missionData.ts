...
export const hazards: Hazard[] = [
  {
    ...
    type: 'CME',
    severity: 'High',
    description: 'Coronal Mass Ejection detected. Velocity: 1,200 km/s. Expected arrival: T+74:00:00',
  ...
  },
  {
    ...
    severity: 'Medium',
    description: 'Space debris cluster detected in lunar approach corridor. Risk of collision: 12%'
  },
  {
    id: 'haz-003',
    ...
    type: 'Solar Flare',
    severity: 'Critical',
    description: 'X-class solar flare in progress. Radiation levels exceeding safety thresholds'
  }
];
...
export const missionLogs: MissionLog[] = [
  {
    ...
    source: 'ODIN-AI',
    message: 'CME detected. Analyzing trajectory alternatives. Recommending switch to Safe Route Alpha for 90% radiation reduction.',
    priority: 'Critical'
  },
  {
    id: 'log-002',
    ...
    source: 'Navigation',
    message: 'Trajectory recalculation complete. New delta-V requirement: 3,280 m/s (+180 m/s). Fuel reserves sufficient.',
    priority: 'Warning'
  },
  {
    id: 'log-003',
    ...
    source: 'ODIN-AI',
    message: 'Route optimization successful. Travel time increased by 12 hours, but crew radiation exposure reduced by 71%.',
    priority: 'Info'
  },
  {
    id: 'log-004',
    ...
    message: 'Approved trajectory change to Safe Route Alpha. Initiating course correction burn in T-15 minutes.',
    priority: 'Info'
  },
  {
    id: 'log-005',
    ...
    message: 'X-class solar flare detected. Duration: 6-8 hours. Immediate shelter protocol activated.',
    priority: 'Critical'
  }
];
